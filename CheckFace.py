                            ...
                            for j,model in enumerate(modelList):
                                ...
                                if results[1] < 500:
                                    ...
                                    if confidence>=70:
                                        ...
                                        os.unlink('/home/pi/scripts/camera/Intruder.jpg')
                                        cv2.imwrite('/home/pi/scripts/camera/'+nameList[j]+'.jpg',frame)
                                        
                            if flag == 0:
                                os.unlink('/home/pi/scripts/camera/Intruder.jpg')
                                cv2.imwrite('/home/pi/scripts/camera/Intruder.jpg',frame)
                    except:
                        pass
